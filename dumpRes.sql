...
INSERT INTO `app_node` VALUES (1,'Требования к компоненту',NULL,1,3,1,2,1,0),(2,'Требования к сопроводительным материалам',NULL,1,3,1,6,2,0),(3,'Требования к пользовательской документации',2,1,1,4,5,2,1),(4,'Требования к демонстрационным примерам',2,1,1,2,3,2,1),(5,'Требования к чему-либо еще',NULL,1,2,1,2,3,0);
...
CREATE TABLE `app_nodeeditionhistory` (
  ...
  KEY `app_nodeeditionhistory_44224078` (`status_id`),
  ...
  CONSTRAINT `status_id_refs_id_1629ab8d` FOREIGN KEY (`status_id`) REFERENCES `app_status` (`id`),
...
INSERT INTO `app_nodeeditionhistory` VALUES (1,'Лемма Шуры-Буры закрепилась как отдельное утверждение с данным названием в монографиях П. С. Александрова, где оно использовалось в качестве вспомогательного для доказательства следующей фундаментальной теоремы, принадлежащей М. Р. Шуре-Буре (1941):\r\nКомпонента связности каждой точки хаусдорфова компактного пространства совпадает с её квазикомпонентой','2012-10-01 08:58:25',1,1,'только создано',2,1);
...
INSERT INTO `app_release` VALUES (1,'первый','2013-01-18 08:56:33','такие-то требования, такие-то составляющие, такие-то и такие-то пожелания и пожаления');
...
CREATE TABLE `app_requirementsedition` (
  ...
  KEY `app_requirementsedition_44224078` (`status_id`),
  CONSTRAINT `requirement_id_refs_id_7e5ee194` FOREIGN KEY (`requirement_id`) REFERENCES `app_requirement` (`id`),
  CONSTRAINT `status_id_refs_id_17b3d786` FOREIGN KEY (`status_id`) REFERENCES `app_status` (`id`),
...
INSERT INTO `app_status` VALUES (1,'сформулировано','неопределённый');
...
INSERT INTO `auth_user` VALUES (1,'admin','','','maresha@list.ru','pbkdf2_sha256$10000$EjM5hP3qxSMC$NKizIBCjZl0GkxiU4nEwxkI/vK9IRWwW6O0xGxHdQ2o=',1,1,1,'2012-10-01 08:52:35','2012-10-01 08:52:07'),(2,'Olga','','','','pbkdf2_sha256$10000$xbiIR0FwsGY1$ymfJOkQ7Lx0vmxk5ITCFC6I41xqjjj3LQMZ8ZRORa1o=',0,1,0,'2012-10-01 08:53:01','2012-10-01 08:53:01'),(3,'Galina','','','','pbkdf2_sha256$10000$7cUSaZ9HnwW8$orF3xMpJs/68Fg+2GwgA7JdFbBwqp8SG6ycQKAe/coE=',0,1,0,'2012-10-01 08:53:17','2012-10-01 08:53:17');
...
INSERT INTO `django_admin_log` VALUES (1,'2012-10-01 08:53:01',1,4,'2','Olga',1,''),(2,'2012-10-01 08:53:17',1,4,'3','Galina',1,''),(3,'2012-10-01 08:53:30',1,9,'1','Требования к компоненту',1,''),(4,'2012-10-01 08:53:47',1,9,'2','Требования к сопроводительным материалам',1,''),(5,'2012-10-01 08:54:03',1,9,'3','Требования к пользовательской документации',1,''),(6,'2012-10-01 08:54:16',1,9,'4','Требования к демонстрационным примерам',1,''),(7,'2012-10-01 08:54:31',1,9,'5','Требования к чему-либо еще',1,''),(8,'2012-10-01 08:57:01',1,10,'1','первый',1,''),(9,'2012-10-01 08:57:57',1,11,'1','сформулировано',1,''),(10,'2012-10-01 08:58:25',1,13,'1','только создано: 2012-10-01 08:58:25.885000+00:00',1,'');
...
INSERT INTO `django_session` VALUES ('f17f7edf1f8710ff9799dbf9e2c78811','Y2VlZGFiNDNiOGY0OWFmNDIwOGUyN2IzNzAyMTA0MDE4NjA2NDZjYzqAAn1xAShVEl9hdXRoX3Vz\nZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHED\nVQ1fYXV0aF91c2VyX2lkcQSKAQF1Lg==\n','2012-10-15 08:52:35');
...
-- Dump completed on 2012-10-02  8:44:04
